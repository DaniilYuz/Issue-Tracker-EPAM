...
const (
	IssueService_CreateIssue_FullMethodName = "/service.IssueService/CreateIssue"
	IssueService_ReadIssue_FullMethodName   = "/service.IssueService/ReadIssue"
	IssueService_UpdateIssue_FullMethodName = "/service.IssueService/UpdateIssue"
	IssueService_DeleteIssue_FullMethodName = "/service.IssueService/DeleteIssue"
	IssueService_ListIssues_FullMethodName  = "/service.IssueService/ListIssues"
)
...
type IssueServiceClient interface {
	...
	ReadIssue(ctx context.Context, in *ReadIssueRequest, opts ...grpc.CallOption) (*ReadIssueResponse, error)
...
func (c *issueServiceClient) ReadIssue(ctx context.Context, in *ReadIssueRequest, opts ...grpc.CallOption) (*ReadIssueResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadIssueResponse)
	err := c.cc.Invoke(ctx, IssueService_ReadIssue_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IssueServiceServer interface {
	...
	ReadIssue(context.Context, *ReadIssueRequest) (*ReadIssueResponse, error)
...
func (UnimplementedIssueServiceServer) ReadIssue(context.Context, *ReadIssueRequest) (*ReadIssueResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReadIssue not implemented")
}
...
func _IssueService_ReadIssue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadIssueRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IssueServiceServer).ReadIssue(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IssueService_ReadIssue_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IssueServiceServer).ReadIssue(ctx, req.(*ReadIssueRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IssueService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "service.IssueService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReadIssue",
			Handler:    _IssueService_ReadIssue_Handler,
		},
		{
